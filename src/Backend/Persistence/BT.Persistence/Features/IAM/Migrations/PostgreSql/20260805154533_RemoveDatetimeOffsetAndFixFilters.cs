        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordLastChanged = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredModule = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Label = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    Url = table.Column<string>(type: "character varying(240)", maxLength: 240, nullable: false),
                    PlacementKey = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    Description = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Key = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    Label = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    ContextKey = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    Description = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Context = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    AppUserId = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
                    TelephoneNo = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TokenFamily = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    DeletedBy = table.Column<string>(type: "text", nullable: true),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9d10514"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "System", null, null, "Approved MudBlazor icon key.", true, false, "Dns", "DNS/platform", new Guid("0194f700-0000-7000-8000-000000000001"), null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c10101"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "System", null, null, null, "Operations dashboard.", 2, "Dashboard", true, false, "dashboard", null, "Sidebar", "core", null, new Guid("0194f700-0000-7000-8000-000000000001"), "Dashboard", null, null, "/dashboard" },
                    { new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c10201"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "System", null, null, null, "Administrative workspace.", 3, "AdminPanelSettings", true, false, "admin-center", null, "Sidebar", "core", null, new Guid("0194f700-0000-7000-8000-000000000001"), "Admin Center", null, null, "/admin" },
                    ...
                    { new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c10501"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "System", null, null, null, "Platform management.", 4, "Dns", true, false, "control-panel", null, "Sidebar", null, "permissions.controlplane.manage", new Guid("0194f700-0000-7000-8000-000000000001"), "Control Panel", null, null, "/control-panel" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9d10403"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "System", null, null, "Platform control plane tiles.", true, false, "ControlPanel", "Control Panel", new Guid("0194f700-0000-7000-8000-000000000001"), null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9d10619"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "System", null, null, "Approved application route.", true, false, "admin-org-settings", "Org Settings", "AdminCenter", new Guid("0194f700-0000-7000-8000-000000000001"), null, null, "/admin/org-settings" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c10402"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "System", null, null, null, "Test card and mobile-money payment flows.", 10, "CreditCard", true, false, "features-payments", new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c10401"), "Features", "showcase", "payments.view", new Guid("0194f700-0000-7000-8000-000000000001"), "Payments", null, null, "/features/payments" },
                    { new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c20101"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "System", null, null, null, "Customer records and onboarding.", 10, "Business", true, false, "admin-customers", new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c10201"), "AdminCenter", "core", null, new Guid("0194f700-0000-7000-8000-000000000001"), "Customers", null, null, "/admin/customers" },
                    { new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c20102"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "System", null, null, null, "Department catalog and staff grouping.", 20, "AccountTree", true, false, "admin-departments", new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c10201"), "AdminCenter", "core", null, new Guid("0194f700-0000-7000-8000-000000000001"), "Departments", null, null, "/admin/departments" },
                    { new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c20103"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "System", null, null, null, "Staff records and system access.", 30, "Badge", true, false, "admin-employees", new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c10201"), "AdminCenter", "core", null, new Guid("0194f700-0000-7000-8000-000000000001"), "Employees", null, null, "/admin/employees" },
                    { new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c20104"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "System", null, null, null, "Navigation catalog and menu visibility.", 40, "MenuOpen", true, false, "admin-menus", new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c10201"), "AdminCenter", "core", null, new Guid("0194f700-0000-7000-8000-000000000001"), "Menus", null, null, "/admin/menus" },
                    { new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c20107"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "System", null, null, null, "Tenant-specific configuration surface.", 50, "Settings", true, false, "admin-org-settings", new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c10201"), "AdminCenter", "core", null, new Guid("0194f700-0000-7000-8000-000000000001"), "Org Settings", null, null, "/admin/org-settings" },
                    { new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c20110"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "System", null, null, null, "Source-of-truth permission and menu reference data.", 70, "LockPerson", true, false, "admin-access-catalog", new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c10201"), "AdminCenter", "iam", null, new Guid("0194f700-0000-7000-8000-000000000001"), "Access Catalog", null, null, "/admin/access-catalog" },
                    { new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c20111"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "System", null, null, null, "Manage users, roles, permissions, and trusted devices.", 60, "Group", true, false, "admin-iam", new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c10201"), "AdminCenter", "iam", null, new Guid("0194f700-0000-7000-8000-000000000001"), "Identity & Access", null, null, "/admin/iam" },
                    { new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c30101"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "System", null, null, null, "Manage SaaS tenants.", 10, "Business", true, false, "control-panel-tenants", new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c10501"), "ControlPanel", null, "permissions.controlplane.manage", new Guid("0194f700-0000-7000-8000-000000000001"), "Tenants", null, null, "/control-panel/tenants" },
                    { new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c30102"), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "System", null, null, null, "Deployment stamps.", 20, "Dns", true, false, "control-panel-stamps", new Guid("018fd81d-2c94-7ad0-a4a3-f1edb9c10501"), "ControlPanel", null, "permissions.controlplane.manage", new Guid("0194f700-0000-7000-8000-000000000001"), "Stamps", null, null, "/control-panel/stamps" }
                });
