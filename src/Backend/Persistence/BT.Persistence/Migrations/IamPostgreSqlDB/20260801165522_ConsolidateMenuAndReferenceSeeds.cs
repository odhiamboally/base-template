...
VALUES ('018fd81d-2c94-7ad0-a4a3-f1edb9c10501', '0194f700-0000-7000-8000-000000000001', NULL, NULL, 'control-panel', 'Control Panel', 'Platform management.', '/control-panel', 'Dns', 'Sidebar', 'Permissions.ControlPlane.Manage', NULL, 4, '2026-01-01T00:00:00.0000000Z', 'System', NULL, NULL, true, false, NULL, NULL)
ON CONFLICT (""Id"") DO NOTHING;

INSERT INTO ""MenuItems"" (""Id"", ""TenantId"", ""ParentId"", ""DepartmentId"", ""Key"", ""Title"", ""Description"", ""Url"", ""Icon"", ""Placement"", ""RequiredPermissionKey"", ""RequiredModule"", ""DisplayOrder"", ""CreatedAt"", ""CreatedBy"", ""UpdatedAt"", ""UpdatedBy"", ""IsActive"", ""IsDeleted"", ""DeletedAt"", ""DeletedBy"")
VALUES ('018fd81d-2c94-7ad0-a4a3-f1edb9c30101', '0194f700-0000-7000-8000-000000000001', '018fd81d-2c94-7ad0-a4a3-f1edb9c10501', NULL, 'control-panel-tenants', 'Tenants', 'Manage SaaS tenants.', '/control-panel/tenants', 'Business', 'ControlPanel', 'Permissions.ControlPlane.Manage', NULL, 10, '2026-01-01T00:00:00.0000000Z', 'System', NULL, NULL, true, false, NULL, NULL)
ON CONFLICT (""Id"") DO NOTHING;

INSERT INTO ""MenuItems"" (""Id"", ""TenantId"", ""ParentId"", ""DepartmentId"", ""Key"", ""Title"", ""Description"", ""Url"", ""Icon"", ""Placement"", ""RequiredPermissionKey"", ""RequiredModule"", ""DisplayOrder"", ""CreatedAt"", ""CreatedBy"", ""UpdatedAt"", ""UpdatedBy"", ""IsActive"", ""IsDeleted"", ""DeletedAt"", ""DeletedBy"")
VALUES ('018fd81d-2c94-7ad0-a4a3-f1edb9c30102', '0194f700-0000-7000-8000-000000000001', '018fd81d-2c94-7ad0-a4a3-f1edb9c10501', NULL, 'control-panel-stamps', 'Stamps', 'Deployment stamps.', '/control-panel/stamps', 'Dns', 'ControlPanel', 'Permissions.ControlPlane.Manage', NULL, 20, '2026-01-01T00:00:00.0000000Z', 'System', NULL, NULL, true, false, NULL, NULL)
ON CONFLICT (""Id"") DO NOTHING;

INSERT INTO ""MenuItems"" (""Id"", ""TenantId"", ""ParentId"", ""DepartmentId"", ""Key"", ""Title"", ""Description"", ""Url"", ""Icon"", ""Placement"", ""RequiredPermissionKey"", ""RequiredModule"", ""DisplayOrder"", ""CreatedAt"", ""CreatedBy"", ""UpdatedAt"", ""UpdatedBy"", ""IsActive"", ""IsDeleted"", ""DeletedAt"", ""DeletedBy"")
VALUES ('018fd81d-2c94-7ad0-a4a3-f1edb9c10401', '0194f700-0000-7000-8000-000000000001', NULL, NULL, 'features', 'Features', 'Reusable platform capability showcases.', '/features', 'MenuOpen', 'Sidebar', NULL, NULL, 4, '2026-01-01T00:00:00.0000000Z', 'System', NULL, NULL, true, false, NULL, NULL)
ON CONFLICT (""Id"") DO NOTHING;

INSERT INTO ""MenuItems"" (""Id"", ""TenantId"", ""ParentId"", ""DepartmentId"", ""Key"", ""Title"", ""Description"", ""Url"", ""Icon"", ""Placement"", ""RequiredPermissionKey"", ""RequiredModule"", ""DisplayOrder"", ""CreatedAt"", ""CreatedBy"", ""UpdatedAt"", ""UpdatedBy"", ""IsActive"", ""IsDeleted"", ""DeletedAt"", ""DeletedBy"")
VALUES ('018fd81d-2c94-7ad0-a4a3-f1edb9c10402', '0194f700-0000-7000-8000-000000000001', '018fd81d-2c94-7ad0-a4a3-f1edb9c10401', NULL, 'features-payments', 'Payments', 'Test card and mobile-money payment flows.', '/features/payments', 'CreditCard', 'Sidebar', 'payments.view', NULL, 10, '2026-01-01T00:00:00.0000000Z', 'System', NULL, NULL, true, false, NULL, NULL)
ON CONFLICT (""Id"") DO NOTHING;
            ");
        }
