...
public sealed class CreateEmployeeRequestValidator : Validator<CreateEmployeeRequest>
{
    ...
    private static bool HaveValidPhoneNumber(CreateEmployeeRequest request)
    {
        try
        {
