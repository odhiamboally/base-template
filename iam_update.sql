BEGIN TRANSACTION;
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory_IAM]
    WHERE [MigrationId] = N'20260507052059_Align_IAM_QueryFilters'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory_IAM]
    WHERE [MigrationId] = N'20260601080011_AddIamSoftDelete'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory_IAM]
    WHERE [MigrationId] = N'20260601132909_AddSoftDeleteToRolesAndIamFilterAlignment'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory_IAM]
    WHERE [MigrationId] = N'20260601171352_AddPermissionCatalog'
)
BEGIN
...
BEGIN
    ...
    EXEC(N'INSERT INTO [Permissions] ([Id], [Action], [Context], [CreatedAt], [CreatedBy], [DeletedAt], [DeletedBy], [Description], [IsActive], [IsDeleted], [Key], [Resource], [TenantId], [UpdatedAt], [UpdatedBy])
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory_IAM]
    WHERE [MigrationId] = N'20260602015650_AddMenuCatalog'
)
BEGIN
...
BEGIN
    ...
    EXEC(N'INSERT INTO [MenuItems] ([Id], [CreatedAt], [CreatedBy], [DeletedAt], [DeletedBy], [Description], [DisplayOrder], [Icon], [IsActive], [IsDeleted], [Key], [ParentId], [Placement], [RequiredPermissionKey], [TenantId], [Title], [UpdatedAt], [UpdatedBy], [Url])
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory_IAM]
    WHERE [MigrationId] = N'20260602104152_HardenIamScopeAndMenus'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [MenuItems] SET [DepartmentId] = NULL
...
BEGIN
    EXEC(N'UPDATE [Permissions] SET [DepartmentId] = NULL
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory_IAM]
    WHERE [MigrationId] = N'20260602231445_AddIamReferenceCatalogs'
)
BEGIN
...
BEGIN
    ...
    EXEC(N'INSERT INTO [MenuIcons] ([Id], [CreatedAt], [CreatedBy], [Description], [IsActive], [Key], [Label], [TenantId], [UpdatedAt], [UpdatedBy])
...
BEGIN
    ...
    EXEC(N'INSERT INTO [MenuPlacements] ([Id], [CreatedAt], [CreatedBy], [Description], [IsActive], [Key], [Label], [TenantId], [UpdatedAt], [UpdatedBy])
...
BEGIN
    ...
    EXEC(N'INSERT INTO [MenuRoutes] ([Id], [CreatedAt], [CreatedBy], [Description], [IsActive], [Key], [Label], [PlacementKey], [TenantId], [UpdatedAt], [UpdatedBy], [Url])
...
BEGIN
    ...
    EXEC(N'INSERT INTO [PermissionActions] ([Id], [CreatedAt], [CreatedBy], [Description], [IsActive], [Key], [Label], [TenantId], [UpdatedAt], [UpdatedBy])
...
BEGIN
    ...
    EXEC(N'INSERT INTO [PermissionContexts] ([Id], [CreatedAt], [CreatedBy], [Description], [IsActive], [Key], [Label], [TenantId], [UpdatedAt], [UpdatedBy])
...
BEGIN
    ...
    EXEC(N'INSERT INTO [PermissionResources] ([Id], [ContextKey], [CreatedAt], [CreatedBy], [Description], [IsActive], [Key], [Label], [TenantId], [UpdatedAt], [UpdatedBy])
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory_IAM]
    WHERE [MigrationId] = N'20260602234334_AddAccessCatalogManagement'
)
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedAt', N'CreatedBy', N'DeletedAt', N'DeletedBy', N'DepartmentId', N'Description', N'Icon', N'IsActive', N'IsDeleted', N'Key', N'ParentId', N'Placement', N'RequiredPermissionKey', N'TenantId', N'Title', N'UpdatedAt', N'UpdatedBy', N'Url') AND [object_id] = OBJECT_ID(N'[MenuItems]'))
        SET IDENTITY_INSERT [MenuItems] ON;
    EXEC(N'INSERT INTO [MenuItems] ([Id], [CreatedAt], [CreatedBy], [DeletedAt], [DeletedBy], [DepartmentId], [Description], [Icon], [IsActive], [IsDeleted], [Key], [ParentId], [Placement], [RequiredPermissionKey], [TenantId], [Title], [UpdatedAt], [UpdatedBy], [Url])
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory_IAM]
    WHERE [MigrationId] = N'20260606114952_AddIamReferenceDataSoftDelete'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [MenuIcons] SET [DeletedAt] = NULL, [DeletedBy] = NULL, [IsDeleted] = CAST(0 AS bit)
...
BEGIN
    EXEC(N'UPDATE [MenuPlacements] SET [DeletedAt] = NULL, [DeletedBy] = NULL, [IsDeleted] = CAST(0 AS bit)
...
BEGIN
    EXEC(N'UPDATE [MenuRoutes] SET [DeletedAt] = NULL, [DeletedBy] = NULL, [IsDeleted] = CAST(0 AS bit)
...
BEGIN
    EXEC(N'UPDATE [PermissionActions] SET [DeletedAt] = NULL, [DeletedBy] = NULL, [IsDeleted] = CAST(0 AS bit)
...
BEGIN
    EXEC(N'UPDATE [PermissionContexts] SET [DeletedAt] = NULL, [DeletedBy] = NULL, [IsDeleted] = CAST(0 AS bit)
...
BEGIN
    EXEC(N'UPDATE [PermissionResources] SET [DeletedAt] = NULL, [DeletedBy] = NULL, [IsDeleted] = CAST(0 AS bit)
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory_IAM]
    WHERE [MigrationId] = N'20260609013225_AlignIamSeedsWithTenantFiltering'
)
BEGIN
...
BEGIN
    EXEC(N'UPDATE [MenuIcons] SET [TenantId] = ''0194f700-0000-7000-8000-000000000001''
    WHERE [Id] = ''018fd81d-2c94-7ad0-a4a3-f1edb9d10501'';
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [MenuItems] SET [TenantId] = ''0194f700-0000-7000-8000-000000000001''
    WHERE [Id] = ''018fd81d-2c94-7ad0-a4a3-f1edb9c10101'';
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [MenuPlacements] SET [TenantId] = ''0194f700-0000-7000-8000-000000000001''
    WHERE [Id] = ''018fd81d-2c94-7ad0-a4a3-f1edb9d10401'';
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [MenuRoutes] SET [TenantId] = ''0194f700-0000-7000-8000-000000000001''
    WHERE [Id] = ''018fd81d-2c94-7ad0-a4a3-f1edb9d10601'';
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [PermissionActions] SET [TenantId] = ''0194f700-0000-7000-8000-000000000001''
    WHERE [Id] = ''018fd81d-2c94-7ad0-a4a3-f1edb9d10301'';
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [PermissionContexts] SET [TenantId] = ''0194f700-0000-7000-8000-000000000001''
    WHERE [Id] = ''018fd81d-2c94-7ad0-a4a3-f1edb9d10101'';
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [PermissionResources] SET [TenantId] = ''0194f700-0000-7000-8000-000000000001''
    WHERE [Id] = ''018fd81d-2c94-7ad0-a4a3-f1edb9d10201'';
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [Permissions] SET [TenantId] = ''0194f700-0000-7000-8000-000000000001''
    WHERE [Id] = ''018fd81d-2c94-7ad0-a4a3-f1edb9b10101'';
    SELECT @@ROWCOUNT');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory_IAM]
    WHERE [MigrationId] = N'20260708094838_AddMenuDisplayOrder'
)
BEGIN
    EXEC(N'DELETE FROM [MenuItems]
    WHERE [Id] = ''018fd81d-2c94-7ad0-a4a3-f1edb9c20105'';
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [MenuItems] SET [DisplayOrder] = 1
    WHERE [Id] = ''018fd81d-2c94-7ad0-a4a3-f1edb9c10101'';
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [MenuItems] SET [DisplayOrder] = 2
    WHERE [Id] = ''018fd81d-2c94-7ad0-a4a3-f1edb9c10201'';
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [MenuItems] SET [DisplayOrder] = 3
    WHERE [Id] = ''018fd81d-2c94-7ad0-a4a3-f1edb9c10301'';
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [MenuItems] SET [DisplayOrder] = 10
    WHERE [Id] = ''018fd81d-2c94-7ad0-a4a3-f1edb9c20101'';
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [MenuItems] SET [DisplayOrder] = 20
    WHERE [Id] = ''018fd81d-2c94-7ad0-a4a3-f1edb9c20102'';
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [MenuItems] SET [DisplayOrder] = 30
    WHERE [Id] = ''018fd81d-2c94-7ad0-a4a3-f1edb9c20103'';
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [MenuItems] SET [DisplayOrder] = 40
    WHERE [Id] = ''018fd81d-2c94-7ad0-a4a3-f1edb9c20104'';
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [MenuItems] SET [DisplayOrder] = 50
    WHERE [Id] = ''018fd81d-2c94-7ad0-a4a3-f1edb9c20107'';
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    EXEC(N'UPDATE [MenuItems] SET [DisplayOrder] = 70
    WHERE [Id] = ''018fd81d-2c94-7ad0-a4a3-f1edb9c20110'';
    SELECT @@ROWCOUNT');
END;
...
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedAt', N'CreatedBy', N'DeletedAt', N'DeletedBy', N'DepartmentId', N'Description', N'DisplayOrder', N'Icon', N'IsActive', N'IsDeleted', N'Key', N'ParentId', N'Placement', N'RequiredPermissionKey', N'TenantId', N'Title', N'UpdatedAt', N'UpdatedBy', N'Url') AND [object_id] = OBJECT_ID(N'[MenuItems]'))
        SET IDENTITY_INSERT [MenuItems] ON;
    EXEC(N'INSERT INTO [MenuItems] ([Id], [CreatedAt], [CreatedBy], [DeletedAt], [DeletedBy], [DepartmentId], [Description], [DisplayOrder], [Icon], [IsActive], [IsDeleted], [Key], [ParentId], [Placement], [RequiredPermissionKey], [TenantId], [Title], [UpdatedAt], [UpdatedBy], [Url])
